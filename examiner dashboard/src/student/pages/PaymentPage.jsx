    ...
    <StudentShell>
      ...
      <section className="student-shell payment-grid">
        ...
        <article className="card-details">
          ...
          <label>Cardholder Name<input value={form.name} onChange={(event) => update('name', event.target.value)} placeholder="Name on card" autoComplete="cc-name" />{errors.name && <span className="student-error">{errors.name}</span>}</label>
